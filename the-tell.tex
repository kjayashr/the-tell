...
so it costs almost nothing next to the work the model is already doing. Figure~\ref{fig:buildrun}
lays out both halves: the probe is built once, ahead of time, and then read on every request.

\begin{figure}[htbp]\centering
\resizebox{0.96\textwidth}{!}{\begin{tikzpicture}[font=\small,node distance=7mm]
  % lane A: build once
...
\begin{figure}[htbp]\centering
\resizebox{0.94\textwidth}{!}{\begin{tikzpicture}[font=\small,node distance=12mm]
...
\begin{figure}[htbp]\centering
\resizebox{0.97\textwidth}{!}{\begin{tikzpicture}[font=\small,node distance=13mm]
