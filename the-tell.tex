...
at the guilty phrase; and against wording that hides the intent in innocent words it only matches a
plain text filter rather than beating it. Where it does fit, an operator who runs their own open
...
so it costs almost nothing next to the work the model is already doing.
...
not do, before the agent has acted (Figure~\ref{fig:pack}). Over the line, we can flag the request,
...
numbers here, $0.993$ on Qwen2.5-1.5B and $1.000$ on Qwen2.5-3B, come from that pipeline and nowhere
else.
